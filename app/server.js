...
app.post("/api/prospects/:id/email", (req, res) => {
  ...
  const promotionHtml = isElectronicInvoiceOffer ? '<div style="margin:20px 0;padding:16px 18px;background:#fff4d6;border:1px solid #f0c45c;border-radius:10px;text-align:center;font-size:17px;"><strong>🎁 Offre de lancement : -20 %</strong><br><span style="font-size:13px;">Pour les 1 000 premiers clients</span></div>' : "";
