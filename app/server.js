...
app.post("/api/prospects/:id/email", (req, res) => {
  ...
  const safe = {
    ...
    sourceUrl: escapeEmailHtml(safeSourceUrl),
  ...
  const approvedBody = `Bonjour,\n\nJe me permets de vous présenter les solutions FÉWURA basées sur l’intelligence artificielle.\n\n1. Agent IA pour automatiser la facturation électronique obligatoire\n\n- Création et traitement des factures ;\n- Suivi des paiements et des relances ;\n- Centralisation des documents ;\n- Réduction des tâches administratives.\n\n2. Agent IA de prospection commerciale\n\n- Recherche de nouveaux prospects ;\n- Identification des entreprises adaptées à votre activité ;\n- Augmentation de votre clientèle ;\n- Préparation et suivi de vos campagnes commerciales.\n\n3. Agent IA pour optimiser la production\n\n- Organisation et planification de la production ;\n- Suivi des tâches et des délais ;\n- Optimisation des ressources ;\n- Réduction des pertes de temps ;\n- Amélioration du suivi des commandes et des opérations.\n\n🎁 Offre de lancement : -20 % pour les 1 000 premiers clients.\n\nBénéficiez également de 20 minutes de communication gratuite pour analyser vos besoins.\n\nTéléphone : +33 7 73 54 78 57\nWhatsApp : https://wa.me/33773547857\nSite : https://innovatechsoftware.eu\n\nBien cordialement,\n\n${sender}\nFÉWURA SYSTEMS`;
  const approvedHtml = `<!doctype html><html lang="fr"><body style="margin:0;background:#f5f6f1;font-family:Arial,Helvetica,sans-serif;color:#152522;"><div style="max-width:620px;margin:0 auto;padding:28px 16px;"><div style="background:#fff;border:1px solid #dfe6df;border-radius:16px;overflow:hidden;"><div style="padding:22px 24px;border-bottom:1px solid #e6ece5;"><table role="presentation" cellpadding="0" cellspacing="0"><tr><td style="width:140px;height:140px;vertical-align:middle;"><img src="cid:fewura-logo" width="140" height="140" alt="FÉWURA SYSTEMS" style="display:block;width:140px;height:140px;border:0;border-radius:12px;"></td><td style="padding-left:16px;vertical-align:middle;"><strong style="font-size:20px;letter-spacing:.05em;">FÉWURA</strong><br><span style="font-size:10px;letter-spacing:.12em;color:#718078;">SYSTEMS</span></td></tr></table></div><div style="padding:28px 24px;line-height:1.55;"><p>Bonjour,</p><p>Je me permets de vous présenter les solutions FÉWURA basées sur l’intelligence artificielle.</p><h3>1. Agent IA pour automatiser la facturation électronique obligatoire</h3><ul><li>Création et traitement des factures ;</li><li>Suivi des paiements et des relances ;</li><li>Centralisation des documents ;</li><li>Réduction des tâches administratives.</li></ul><h3>2. Agent IA de prospection commerciale</h3><ul><li>Recherche de nouveaux prospects ;</li><li>Identification des entreprises adaptées à votre activité ;</li><li>Augmentation de votre clientèle ;</li><li>Préparation et suivi de vos campagnes commerciales.</li></ul><h3>3. Agent IA pour optimiser la production</h3><ul><li>Organisation et planification de la production ;</li><li>Suivi des tâches et des délais ;</li><li>Optimisation des ressources ;</li><li>Réduction des pertes de temps ;</li><li>Amélioration du suivi des commandes et des opérations.</li></ul><p style="padding:16px;background:#fff4d6;border:1px solid #f0c45c;border-radius:10px;text-align:center;"><strong>🎁 Offre de lancement : -20 % pour les 1 000 premiers clients.</strong><br><br>Bénéficiez également de 20 minutes de communication gratuite pour analyser vos besoins.</p><p><strong>Téléphone :</strong> <a href="tel:+33773547857">+33 7 73 54 78 57</a><br><strong>WhatsApp :</strong> <a href="https://wa.me/33773547857">Contacter FÉWURA sur WhatsApp</a><br><strong>Site :</strong> <a href="https://innovatechsoftware.eu">Découvrir FÉWURA SYSTEMS</a></p><p>Bien cordialement,<br><strong>${safe.sender}</strong><br>FÉWURA SYSTEMS</p></div></div></div></body></html>`;
  try {
    db.prepare("INSERT INTO activities (prospect_id, type, content, created_at) VALUES (?, ?, ?, ?)")
  ...
  res.json({ subject: "Optimisez votre activité et développez votre clientèle avec un Agent IA", body: approvedBody, html: approvedHtml, disclaimer: "Message commercial validé. Vérifiez le destinataire avant tout envoi." });
});
