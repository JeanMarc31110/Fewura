...
app.post("/api/prospects/:id/email", (req, res) => {
  ...
  const isElectronicInvoiceOffer = normalizedText(offer).includes("facture electronique");
  ...
  const contactLinks = `${safe.sourceUrl ? `<br><strong>Site de l’entreprise :</strong> <a href="${safe.sourceUrl}" style="color:#1b65d6;">${safe.source}</a>` : ""}${safe.phone ? `<br><strong>Téléphone :</strong> <a href="${safe.phoneHref}" style="color:#1b65d6;">${safe.phone}</a>` : ""}${safe.whatsappUrl ? ` · <a href="${safe.whatsappUrl}" style="color:#168c4b;font-weight:700;">Écrire sur WhatsApp</a>` : ""}`;
